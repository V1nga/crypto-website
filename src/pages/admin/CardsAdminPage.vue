    ...
    <FPage>
        ...
        <template #default>
            <FCard v-if="tab === 0" class="p-0 xl:p-6 h-full flex flex-wrap 2xl:flex-nowrap gap-x-12">
                <div class="p-6 xl:p-0 xl:mb-4 2xl:mb-12 w-full 2xl:w-[400px] text-sm flex flex-col gap-4">
                    <FButton light fill @click="addCardMessageBoxOpen">
                        <FIcon icon="plus-primary" class="mr-3"/>
                        Добавить карту
                    </FButton>
                    <div class="h-full">
                        <div class="mb-4 text-xs font-bold">Добавленные карты</div>
                        <FList
                        ...
                        >
                            <template #item="{ item, isSelected }">
                                <div
                                    ...
                                    class="p-3 rounded-xl whitespace-nowrap text-sm font-semibold flex flex-nowrap justify-center gap-x-4"
                                >
                ...
                <FCard v-if="selectedCard" no-paddings class="relative w-full">
                    <div class="p-6 pb-24 rounded-t-xl bg-active font-bold grid md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                        ...
                        <div>
                            ...
                            <FMoney :money="3346" currency="USD" text-size="xl" slug-text-size="xs" font-weight="bold"/>
                        </div>
                        <div>
                            <p class="text-sm whitespace-nowrap">Попыток пополнения</p>
                            <FNumber :number="3346" class="text-primary"/>
                        </div>
                        <div>
                            <p class="text-sm whitespace-nowrap">Успешных попыток</p>
                            <FNumber :number="2345" class="text-success"/>
                        </div>
                        <div>
                            <p class="text-sm whitespace-nowrap">Не успешных попыток</p>
                            <FNumber :number="1345" class="text-danger"/>
                        </div>
                        <div>
                    ...
                    >
                        <template #item-statusDate="{ item }">
                            <div>
                                ...
                                <div class="mt-2 text-xs text-secondary font-bold flex flex-nowrap items-center gap-2">
                                    {{ item.statusDate }}
                                    <button>
                                        <FIcon icon="person"/>
                                    </button>
